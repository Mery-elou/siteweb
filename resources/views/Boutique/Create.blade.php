...
<head>
    ...
    <!-- Main CSS-->
    <link href="colorlib-regform-3/css/main1.css" rel="stylesheet" media="all">
</head>
    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Créer Votre Boutique</h2>
                    <form method="POST"   action="{{ route('bt.store') }}">>
                        @csrf
                        @method('POST')
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Nom De Boutique" name="boutique">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="N° De Carte Bancaire " name="carte">
                        </div>
                        <div class="input-group">
