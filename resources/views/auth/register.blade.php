...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header " >  <strong style=" color: rgb(139, 136, 162);margin-left: 10px; display: inline-block" >Crée Compte Client </strong><img src="{{asset('Images/logo.png')}}"  style="margin-left: 350px" alt=""></div>
