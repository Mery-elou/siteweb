        ...
        <div style="margin-left:20%;padding:1px 16px;">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr></tr>
                  <td>{{$boutique ->id}}</td>
                  <td>{{$boutique ->f_nam}}</td>
                  <td>{{$boutique ->email}}</td>
                  <td>{{$boutique ->nom_store}}</td>
                  <td>{{$boutique ->banque}}</td>
                  {{-- <form  action="{{route('admin.delete_boutique', $boutique ->id)}}" method="post">
                    @csrf @method('DELETE')
                       <td><button href = 'delete/{{ $boutique ->id }}' type="submit" class="btn "><i class="fa fa-solid fa-trash-can" style="color: red;font-size: 22px"></i>
                    </button>

                  </form> --}}

                  <form   action="{{route('admin.delete_store', $boutique->id)}}" method="post">
                    @csrf @method('DELETE')
                       <td><button type="submit" class="btn "><i class="fa fa-solid fa-trash-can" style="color: red;font-size: 22px"></i>
                     </button>
