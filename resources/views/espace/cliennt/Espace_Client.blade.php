            ...
            <div style="display: block;"></div>
                ...
                <div class="info">
                    <div style="float: right;">
                        @if (Auth::user()->image) <img src="{{ asset('Images/profile/'.Auth::user()->image) }}"  class="image-ronde" > @else <div style="font-size: 150px"> <i class="fa fa-solid fa-circle-user"></i></div> @endif
                    ...
                    <div class="info_ecriture">
                        <span class="info_ecriture"> Nom :</span><strong> {{ Auth::user()->name }}  </strong>
                    </div>
                    ...
                    <div class="info_ecriture">
                        <span class="info_ecriture">Sexe :</span><strong> {{ Auth::user()->sexe }}  </strong>
                    </div>

                    <div class="info_ecriture">
                        <span class="info_ecriture">Age :</span><strong> {{ Auth::user()->age }}  ans</strong>
                    </div>
                    <!-- The Modal -->
                ...
                <div class="container">
                    <form method="POST" action="{{route('update_user')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="adresse">age :</label>
                            <input type="number" class="form-control" id="age"  name="age" min="17" value="{{ Auth::user()->age }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="banque" value="97845697845697845698" name="banque">
                            </div>
