...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Handy Marocaine - Produits</title>
   ...
   <body>
      ...
      <div class="product_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h1 class="product_taital">NOUS PRODUITS</h1>
                  <p class="product_text">Veuilez parcourir le meilleur du produits artisanats marrocaines !</p>
               </div>
            </div>
